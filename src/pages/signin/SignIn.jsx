...
export default function SignIn() {
  ...
  // to get email from the input & set the value of email
  const getEmail = (event) => {
    console.log(event.target.value);
    setSignInObj((prev) => ({ ...prev, email: event.target.value }));
  };
  // to get password from the input & set the value of password
  ...
  const  Submit = async() => {
    ...
    //if email and password pattern match, will send the credential to server and get the token 
